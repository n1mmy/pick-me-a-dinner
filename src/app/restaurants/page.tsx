...
export default async function RestaurantsPage({
  ...
  return (
    <div className="space-y-6">
      <SubNav items={BROWSE_ITEMS} activeHref="/restaurants" />
      <div>
            ...
            <details key={r.id} className="group border-b border-dashed border-muted/30">
              <summary className="list-none flex items-center gap-3 py-3 cursor-default">
                <div className="flex-1 min-w-0">
                  ...
                  {last?.date && <p className="text-xs text-muted/60 mt-0.5 font-mono">Last ordered {formatShortDate(last.date, now)}</p>}
